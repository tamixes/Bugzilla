...
public abstract class CalculaDistancia {
	...
	public static void main(String[] args) {
		...
		Local l1 = new Local("Recife", -08.0314, -34.5252);
		Local l2 = new Local("Manaus", -03.0607, -60.0130);
		
		double distancia = DistanciaGeoEmKm(l1,l2);
		System.out.println("distancia de recife para manaus: " + String.format("%fkm", distancia));
	}
}
